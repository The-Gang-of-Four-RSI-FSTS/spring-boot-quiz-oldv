...
@DataJpaTest
// @TestMethodOrder(OrderAnnotation.class) // to run by order we add
// @order(ordernumber) before the methods
@AutoConfigureTestDatabase(replace = AutoConfigureTestDatabase.Replace.NONE)
// to run this test uncomment the autoconfigure and change ddl-auto to
// create-dop /none
public class QuestionTests {
	...
	// @Test
	// @Rollback(false) // to save the data in DB // for that change
